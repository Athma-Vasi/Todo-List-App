...
const handleTodoFormSubmit = function (ev) {
    ...
    const storeProjectAndTodoNames = (function (currentProjName_, currentTodoName_) {
        var _a;
        const currentProjAndTodosNames = {
            projName: currentProjName_,
            todoNames: [currentTodoName_],
        };
        const projAndTodosNamesStorage = JSON.parse((_a = localStorage.getItem('projAndTodosNames')) !== null && _a !== void 0 ? _a : '');
    ...
    const storeProjectAndTodosFull = (function (projectAndTodos_) {
        ...
        const projNamesArr = JSON.parse((_a = localStorage.getItem(storageKeys[0])) !== null && _a !== void 0 ? _a : '');
        log({ projNamesArr });
        const storageArr = JSON.parse((_b = localStorage.getItem(storageKeys[1])) !== null && _b !== void 0 ? _b : '');
        log({ storageArr });
        const projAndTodosNamesArr = JSON.parse((_c = localStorage.getItem(storageKeys[2])) !== null && _c !== void 0 ? _c : '');
